...
model_path=gongyisheng/qwen-2.5-3b-instruct-multiturn-sft-ckpt-186
...
experiment_name=qwen2.5_3b_instruct_sft_186_dapo_8xa6000
default_local_dir=$DATA_ROOT/checkpoints/retool/$experiment_name
