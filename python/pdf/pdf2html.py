...
async def async_pdf2html(input_file, output_file):
    ...
    await loop.run_in_executor(exe, functools.partial(pdf2html, input_file, output_file))
    exe.shutdown()
...
async def main(file_path):
    ...
    await timeout_run_func(60, async_pdf2html, f'{file_path}-1.pdf', f'{file_path}-1.html')
